INPUT_FILE = tests/milestones/Milestone2.java
...
clean:
	rm minijavac/*.class  minijavac/tools/*.class minijavac/syntaxtree/*.class minijavac/visitor/*.class minijavac/ir/*.class minijavac/graph/*.class minijavac/mips/*.class
